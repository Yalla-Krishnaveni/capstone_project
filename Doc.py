...
#       if len(row)>=2:
#         data1['page_content'].append(doc.page_content)
#         corpus_embeddings=embeddings.embed_documents([page_content])
#         data1['page_content'].append(page_content)
#         data1['metadata'].append(metadata)
#         data1['Embeddings'].append(corpus_embeddings)
